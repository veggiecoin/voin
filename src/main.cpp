...
// Copyright (c) 2014 The Voin developers
...
uint256 hashGenesisBlock("0x000000c7a6441a589d2fef7fcfb86628b95707d6fcc0e0fc7248b92918ae8a1b");
static const int COINBASE_MATURITY2 = 1;
static const unsigned int timeGenesisBlock = 1429100341;
static const unsigned int nNonceGenesisBlock = 28578105;
...
const string strMessageMagic = "Voin Signed Message:\n";
...
int CMerkleTx::GetBlocksToMaturity() const
{
    if (!IsCoinBase())
        return 0;
    return max(0, (COINBASE_MATURITY2+20) - GetDepthInMainChain());
}
...
static const int64 nBlockRewardStartCoin = 111 * COIN; //Lacerta
static const int64 nBlockRewardFork1Coin = 48 * COIN;
static const int64 nBlockRewardFork3Coin = 16 * COIN;

static const int64 nTargetTimespan =  60*60; // retarget every 3 minutes Lacerta
static const int64 nTargetSpacing = 60; // 30 seconds Lacerta
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000c7a6441a589d2fef7fcfb86628b95707d6fcc0e0fc7248b92918ae8a1b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Carb the fuck up";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x96bdf1a37df79c88a96d5cbfb11f7ad3e86362d63e1c474404a7a31ff9b96ff2"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("VoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("voin-miner");
    ...
    try { while(true) {
        ...
        printf("Running VoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
